    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (args[0] == "client")
            {
                ...
                if (rc == -1)
                {
                    Console.WriteLine("There was an error connecting to '" + socketAddress + "': " + NNanomsg.Errno());
                }
            ...
            else if (args[0] == "server")
            {
                ...
                if (rc == -1)
                {
                    Console.WriteLine("There was an error binding to '" + socketAddress + "': " + NNanomsg.Errno());
                }
